            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.only(
                    left: 14, top: 6), // Adjust the left padding
              ),
            ),
          ),
          SizedBox(height: 20),
            ...
            child: GestureDetector(
              ...
              child: Padding(
                padding: EdgeInsets.only(
                    left: 16, top: 20), // Adjust the left padding
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                Container(
                  child: Row(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: 16, top: 14), // Adjust the left padding
                        child: Text(
                          'Status',
                          style: TextStyle(
                            color: Color(0xFFA3A3A3),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 1), // Adjust the left padding
                      child: Text(
                        'Kehilangan',
                        style: TextStyle(
                          color: Colors.black,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: InputBorder.none,
                contentPadding: EdgeInsets.only(
                    left: 16, top: 17), // Adjust the left padding
              ),
            ),
          ),
        ],
